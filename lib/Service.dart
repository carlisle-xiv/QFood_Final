...
import 'package:q_food/common/card_picture.dart';
import 'package:q_food/common/take_photo.dart';
import 'package:q_food/service/http_upload_service.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          children: [
            Text('Q-FOOD', style: TextStyle(fontSize: 25.0, color:Colors.green,
